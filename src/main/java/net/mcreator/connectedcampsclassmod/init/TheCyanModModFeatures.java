...
import net.mcreator.connectedcampsclassmod.world.features.ores.CyanOreFeature;
...
public class TheCyanModModFeatures {
	private static final Map<Feature<?>, FeatureRegistration> REGISTRY = new HashMap<>();
	static {
		REGISTRY.put(CyanOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, CyanOreFeature.GENERATE_BIOMES,
				CyanOreFeature.CONFIGURED_FEATURE));
	}
