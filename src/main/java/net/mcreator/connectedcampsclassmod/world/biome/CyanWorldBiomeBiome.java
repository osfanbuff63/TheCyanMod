...
package net.mcreator.connectedcampsclassmod.world.biome;
...
import net.mcreator.connectedcampsclassmod.TheCyanModMod;

import java.util.Map;
import java.util.HashMap;

public class CyanWorldBiomeBiome {
	private static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = SurfaceBuilder.DEFAULT
			.configured(new SurfaceBuilderBaseConfiguration(Blocks.CYAN_CONCRETE_POWDER.defaultBlockState(),
					TheCyanModModBlocks.CYAN_STONE.defaultBlockState(), TheCyanModModBlocks.CYAN_STONE.defaultBlockState()));
	...
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, register("trees", Feature.TREE
				.configured((new TreeConfiguration.TreeConfigurationBuilder(new SimpleStateProvider(Blocks.WARPED_STEM.defaultBlockState()),
						new StraightTrunkPlacer(7, 2, 0), new SimpleStateProvider(Blocks.WARPED_STEM.defaultBlockState()),
	...
	public static void init() {
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new ResourceLocation(TheCyanModMod.MODID, "cyan_world_biome"),
				SURFACE_BUILDER);
	...
	private static ConfiguredFeature<?, ?> register(String name, ConfiguredFeature<?, ?> configuredFeature) {
		CONFIGURED_FEATURES.put(new ResourceLocation(TheCyanModMod.MODID, name + "_cyan_world_biome"), configuredFeature);
